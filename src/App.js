...
var features = [
  {
    id: 1,
    name: 'Creative',
    about: 'I constantly have ideas and projects that I would love to create. I enjoy the challenge of using technology to build these ideas.',
    icon: featureIdeas
  },
  {
    id: 2,
    name: 'Technical',
    about: 'I understand how computers function and have the ability to explain code and web to non-technical persons.',
    icon: featureCode
  },
  {
    id: 3,
