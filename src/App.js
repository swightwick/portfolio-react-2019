...
var Projectlist = {
  projects: [
    ...
    { number: 6, 
      name: "RESPONSIVE E-MAILS", 
      slug: "emails",
      link: "///",
      headline: "E-mails that are opened in the thousands across multiple devices, clients and Outlook versions",
      year: "2017", 
      image1: "../assets/7-responsive-e-mails-banners/email-main.jpg" ,
      image2: "../assets/7-responsive-e-mails-banners/repsonsive-email-army.jpg" ,
      image3: "../assets/7-responsive-e-mails-banners/responsive-email-bike.jpg" ,
      image4: "../assets/7-responsive-e-mails-banners/plusnet-banner.jpg" ,
      image5: "/",
      ...
      para4: "",
      para5: "After the long awaited death of flash, animated banners are made in more modern web technologies, and utilise CSS3 animation and javascript as used on normal web sites. These banners were for active marketing campaigns and required a quick turn around delivery time. The banners were delivered to sites through the Google Double Click network.",
      para6: ""
    }
  ],
  ...
  render() {
    ...
    <div>
      ...
      <section className={`project ${project.slug}`}>
          ...
          {/* <img alt={project.image4} src={project.image4 ? project.image4: null} ref={(e)=> {project.image4 = e;}}/> */}
          <Link to={project.link} className="projectLink" target="_blank" rel="noopener noreferrer">Project website</Link>
...
var demos = [
  {
    ...
    image: 'assets/home/burberry.png',
